...
export const metadata: Metadata = {
  title: "Brew Haven - Specialty Coffee Roastery",
  description: "Discover premium specialty coffee at Brew Haven. Fresh roasted beans, signature espresso drinks, and the perfect coffee experience.",
  keywords: "specialty coffee, espresso, café, coffee shop, coffee roastery",
  robots: {
    index: true,
    follow: true
  },
  ...
  twitter: {
    ...
    description: "Premium specialty coffee roastery with signature drinks"
  }
};
